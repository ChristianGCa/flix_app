...
class GenreService:
    ...
    # O serviço de genres inicializa o serviço de repository, pois precisa dele
    def __init__(self):
    ...
    # A lógica de montar um novo gênero fica aqui no service.
    # Quando montar, manda para para o repository
